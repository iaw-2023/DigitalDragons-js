    ...
    <div className="page-container bg-gray-100 h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        ...
        <div
          ...
          <p className="mt-4 max-w-2xl bg-white bg-opacity-50 rounded text-xl text-black lg:mx-auto text-center border-3 p-4">
...
<section className="landing-section  center text-black mt-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 bg-white bg-opacity-50 rounded gap-4">
        <FlightCategory
          title="Económica"
          price={flightData.precio}
          selectedCategory={selectedCategory}
          handleCategoryChange={handleCategoryChange}
        />
        <FlightCategory
          title="Premium Economy"
          price={Math.floor(flightData.precio * 1.3)}
          selectedCategory={selectedCategory}
          handleCategoryChange={handleCategoryChange}
        />
        <FlightCategory
          title="Business"
          price={Math.floor(flightData.precio * 1.7)}
          selectedCategory={selectedCategory}
          handleCategoryChange={handleCategoryChange}
        />
        <FlightCategory
          title="Primera clase"
          price={Math.floor(flightData.precio * 2.1)}
          selectedCategory={selectedCategory}
          handleCategoryChange={handleCategoryChange}
        />
      </div>
...
<button
  ...
  className={`mt-4 ${(selectedCategory && localStorage.getItem('access_token')) ? 'border-2 border-blue-500 hover:bg-blue-500 hover:text-white text-blue-500' : 'border-2 border-black'} bg-white rounded font-bold py-2 px-4 rounded`}
>
